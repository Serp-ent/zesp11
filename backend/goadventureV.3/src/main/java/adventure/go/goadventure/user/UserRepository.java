...
public class UserRepository {
    ...
    public void create(User user) {
        String sql = "INSERT INTO public.\"User\" użytkownik (id_user, login, email, password) " +
                "VALUES (:id_user, :login, :email, :password)";
        MapSqlParameterSource params = new MapSqlParameterSource()
                .addValue("id_user", user.getId_user())
    ...
    public void save(User user) {
        String sql = "INSERT INTO public.\"User\" (login, email, password) " +
                ...
                "ON CONFLICT (id_user) " +
                "DO UPDATE SET login = :login, email = :email, password = :password";
        MapSqlParameterSource params = new MapSqlParameterSource()
                .addValue("login", user.getLogin())
                .addValue("email", user.getEmail())
                .addValue("password", user.getPassword());
